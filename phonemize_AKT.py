...
akt_dataset_path = '/srv/scratch/z5369417/created_dataset_3009/AKT_complete_removal'  # Path to the AKT dataset
output_path = '/srv/scratch/z5369417/outputs/phonemization_AKT3'  # Path to save the phonemized dataset
